...
const SmallScreenCards = ({ match, players, timer }) => {
  return <div style={{ verticalAlign: 'middle', height: '100vh', display: 'flex', flexDirection: 'column' }} className='presentation small-screen'>
    <PlayerCard lp={players[0].lp} name={players[0].name} deckUrl={players[0].deckUrl} match={match} winWith={0} />
    <PlayerCard lp={players[1].lp} name={players[1].name} deckUrl={players[1].deckUrl} match={match} winWith={1} />
